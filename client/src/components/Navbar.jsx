      ...
      <div className="flex gap-10 items-center relative">
        ...
        {!isLanding &&
          (<>
            ...
            {modalopen &&
              <div className="absolute top-[65px] flex flex-col  right-[5px]  bg-[--background3] w-[200px] h-[270px] rounded-sm">
                <div className="w-full flex items-end justify-end px-2 py-2 text-[--ternary]">
                  <div><X size={19} onClick={() => setModalopen(false)} /></div>
                </div>
                <div className="w-[90%] mx-auto  h-[120px] mt-[5px] ">
                  ...
                  <div className="w-full flex flex-col gap-3  text-[--ternary] font-semibold justify-center items-center">
                    ...
                    <h1 className="text-[20px] font-normal">Hi , <span className="font-semibold">{user?.username || 'User'}</span></h1>
                  </div>

                  <div className="text-[--ternary] w-[100%] flex justify-between rounded-sm  items-center h-[45px] mt-1 hover:bg-[--background2] transition-all hover:cursor-pointer ">
                  ...
                  <div className="text-[--ternary] w-[100%] flex justify-between rounded-sm  items-center h-[45px] mt-3 hover:bg-[--background2] hover:cursor-pointer"
